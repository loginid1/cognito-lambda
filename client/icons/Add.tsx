    ...
    <svg width="20" height="20" viewBox="0 0 500 510">
      <g>
        <g>
          <path
            fill={fill}
            d="M487.77,243.877C487.77,109.402,378.368,0,243.887,0C109.402,0,0,109.402,0,243.877
          ...
          <path
            fill={fill}
            d="M282.414,282.372h53.027c21.79,0,39.445-17.592,39.445-39.373c0-20.965-17.001-37.898-37.967-37.898h-54.507v-52.783
